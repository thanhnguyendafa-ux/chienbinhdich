...
export const g6U2TrapFolders = Object.freeze([
  Object.freeze({
    ...
    description: 'Chẩn đoán một bài làm sai: tìm lỗi → sửa → nói lý do. Có lý thuyết ôn lại. Không Listening.',
    parentId: 'global6-unit2',
    order: 2
  }),
  Object.freeze({ id:'global6-unit2-trap-vocab', name:'01 · Vocabulary', description:'Odd one out, chọn từ theo câu và quan hệ từ vựng Unit 2.', parentId:'global6-unit2-exam-traps', order:1 }),
  ...
  Object.freeze({ id:'global6-unit2-trap-reading', name:'03 · Reading', description:'True/False, số và chi tiết, WH, it/them/one.', parentId:'global6-unit2-exam-traps', order:3 }),
  ...
  Object.freeze({ id:'global6-unit2-trap-mixed', name:'07 · Mixed Challenge', description:'Easy → Medium → Hard; thông tin đúng nhưng có thể bị gắn sai chỗ.', parentId:'global6-unit2-exam-traps', order:7 })
]);
...
export const g6U2TrapRegistry = Object.freeze(g6U2TrapSource.map(source => {
  ...
  return Object.freeze({
    ...
    title: source.title,
    subtitle: '4 lựa chọn · Sai – Sửa – Vì · Có lý thuyết',
    ...
    description: `${itemCount} tình huống bẫy Unit 2. Mỗi câu có 4 giải thích ngắn, vị trí đáp án được tráo theo lượt; học sinh có thể mở lý thuyết ôn lại bất kỳ lúc nào.`,
