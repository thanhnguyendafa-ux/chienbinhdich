...
const lessonSpecs = Object.freeze([
  ...
  Object.freeze({ key: 'c1', order: 7, title: 'C1 · Chọn mẫu giới thiệu phù hợp', expectedTimeMinutes: 6, itemCount: 1, activityTypes: ['mcq'] }),
  ...
  Object.freeze({ key: 'c3', order: 9, title: 'C3 · Chọn bài nói đầy đủ về trường', expectedTimeMinutes: 10, itemCount: 1, activityTypes: ['mcq'] }),
  ...
  Object.freeze({ key: 'e3', order: 15, title: 'E3 · Chọn đoạn văn đúng yêu cầu nội quy lớp', expectedTimeMinutes: 15, itemCount: 1, activityTypes: ['mcq'] })
]);

export const g6U1WorkbookFolders = Object.freeze([
  Object.freeze({ id:'global6-unit1-workbook', name:'Sách bài tập · Unit 1', description:'Bài SBT Global Success 6 Unit 1 giữ mục tiêu nguồn và thêm preload Anh→Việt theo từng bài: Nhắc nhanh → Từ vựng → Cụm từ → bài SBT. Toàn bộ bài nguồn sau adaptation dùng MCQ hoặc sắp xếp; Unit 1 không còn ô typing. Chỉ A2 và B1 còn loại vì thật sự cần hình.', parentId:'global6-unit1', order:1 })
]);
...
function descriptor(spec) {
  ...
  return Object.freeze({
    id:`g6-u1-wb-${spec.key}`, folderId:'global6-unit1-workbook', order:spec.order, version:6,
