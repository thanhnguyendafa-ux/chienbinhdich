...
const LOADERS=Object.freeze({
  4:()=>Promise.all([import('./units/u04/ab.js'),import('./units/u04/cd.js'),import('./units/u04/e.js')]).then(([ab,cd,e])=>Object.freeze({...ab.default,...cd.default,...e.default})),
