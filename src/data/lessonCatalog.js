...
export const lessonRegistry = Object.freeze([
  Object.freeze({
    ...
    assignmentSlug: 'g7u1-hobbies-mix',
    passThreshold: 80,
  ...
  Object.freeze({
    ...
    assignmentSlug: 'g7u1-hobby-typing',
    passThreshold: 80,
    teacher: 'Thầy Thành MRT',
  ...
  Object.freeze({
    ...
    assignmentSlug: 'g6u1-3-gan-aura-mix',
    passThreshold: 80,
    teacher: 'Thầy Thành MRT',
  ...
  Object.freeze({
    ...
    assignmentSlug: 'mrt-left-cut-right-mix',
    passThreshold: 80,
    teacher: 'Thầy Thành MRT',
