...
export const g6U1WritingScaffold = Object.freeze({
  ...
  lexicon: Object.freeze({
    ...
    street: entry('đường phố'), house: entry('nhà'), park: entry('công viên'), front: entry('phía trước'),
    class: entry('lớp / lớp học'), student: entry('học sinh'), over: entry('hơn'), twenty: entry('hai mươi'),
    classroom: entry('lớp học'), playground: entry('sân chơi'), large: entry('lớn'), behind: entry('phía sau'),
    ...
    have: entry('có', 'have'), do: entry('làm'), maths: entry('toán'), english: entry('tiếng Anh', 'English'),
