...
// Chỉ các câu trả lời dài cố định mang tính recognition mới chuyển sang MCQ.
// E1 rewrite KHÔNG nằm ở đây: học sinh phải tự thêm từ/cấu trúc để giữ nghĩa, nên giữ typing.
const SPECS = freeze([
...
export function adaptG6U2WorkbookLongAnswers(key, content) {
  if (!['c3','d3b'].includes(String(key ?? '').toLowerCase())) return content;
