...
export const g6U1MixedTestFolders = Object.freeze([
  Object.freeze({
    ...
    description: '4 bài test Unit 1, mỗi bài 25 câu, giữ dạng đề: MCQ, fill/typing, True-False, matching, dialogue order, sentence order, error correction và writing có kiểm soát. Giải thích tiếng Việt sau Submit dành cho học sinh yếu.',
...
export const g6U1MixedTestRegistry = Object.freeze(specs.map(spec => Object.freeze({
  ...
  title: spec.title,
  subtitle: '25 câu · Dạng đề thật · Giải thích tiếng Việt sau Submit',
  ...
  description: 'Mixed Unit 1 test grounded in TAP 1 exercise formats and the GS6 Unit 1 corpus. Student view stays exam-like; feedback after Submit explains context, rule/reason and answer in simple Vietnamese.',
