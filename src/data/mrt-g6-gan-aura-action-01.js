...
function feedbackSpec(classId, reason, example, theory = THEORY[classId]) {
  return Object.freeze({ classId, reason, example, theory });
}

function trueFalse(number, unitKey, sentence, claimClassId, answer, feedback) {
  return {
    id: itemId(number),
    type: 'true_false',
    sourceUnit: UNITS[unitKey],
    ...
    answer,
    teachingFeedback: teaching(feedback.classId, feedback.reason, feedback.example, feedback.theory)
  };
}
...
const items = [
  ...
  trueFalse(4, 'u1', 'Mai là bạn cùng lớp của tôi.', 'action', false, feedbackSpec('gan', '“bạn cùng lớp của tôi” trả lời câu hỏi Mai LÀ AI. “classmate” là danh từ chỉ người.', 'Mai is my classmate.')),
  ...
  trueFalse(6, 'u1', 'Nam làm bài tập về nhà sau giờ học.', 'action', true, feedbackSpec('action', '“làm bài tập về nhà” trả lời câu hỏi Nam LÀM GÌ. Đây là một hoạt động.', 'Nam does his homework after school.')),
  ...
  trueFalse(8, 'u2', 'Nhà của Lan là một ngôi nhà phố.', 'aura', false, feedbackSpec('gan', '“một ngôi nhà phố” cho biết nhà của Lan LÀ LOẠI NHÀ GÌ. Đây là một nhóm danh từ.', "Lan's house is a town house.")),
  ...
  trueFalse(10, 'u2', 'Mẹ tôi nấu ăn trong bếp.', 'aura', false, feedbackSpec('action', '“nấu ăn trong bếp” trả lời câu hỏi mẹ tôi LÀM GÌ. “nấu ăn” là hành động.', 'My mother cooks in the kitchen.')),
  ...
  trueFalse(12, 'u2', 'Phòng của tôi sáng.', 'aura', true, feedbackSpec('aura', '“sáng” trả lời câu hỏi phòng của tôi NHƯ THẾ NÀO. Đây là tính từ mô tả đặc điểm.', 'My room is bright.')),
  ...
  trueFalse(14, 'u2', 'Đó là căn hộ của tôi.', 'gan', true, feedbackSpec('gan', '“căn hộ của tôi” trả lời câu hỏi đó LÀ CÁI GÌ. “flat” là danh từ.', 'That is my flat.')),
  ...
  trueFalse(16, 'u3', 'Nam là bạn thân của tôi.', 'aura', false, feedbackSpec('gan', '“bạn thân của tôi” trả lời câu hỏi Nam LÀ AI. “friend” là danh từ, khác với “friendly” là tính từ.', 'Nam is my best friend.', 'LÀ AI? → GÁN TO BE. friend = noun; friendly = adjective.')),
  ...
  trueFalse(18, 'u3', 'Nam chơi thể thao với bạn bè.', 'action', true, feedbackSpec('action', '“chơi thể thao” trả lời câu hỏi Nam LÀM GÌ. Đây là hành động.', 'Nam plays sports with his friends.')),
